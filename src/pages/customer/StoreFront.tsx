...
export default function StoreFront() {
  ...
  return (
    <div className="min-h-screen font-sans" style={{ background: '#fdf5e6' }}>
      ...
      {/* Footer */}
      <footer className="pt-10 pb-8 text-center" style={{ background: 'linear-gradient(160deg, #3d1c02 0%, #1a0a00 100%)' }}>
        <div className="max-w-md mx-auto px-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="https://chat.whatsapp.com/ERmWl4UOBZOLw9aiX3lu1h" target="_blank" rel="noreferrer"
              className="flex items-center gap-3 rounded-xl px-4 py-3 text-left"
            ...
            {/* WA Channel */}
            {APP_CONFIG.WHATSAPP_CHANNEL_LINK && (
            ...
            {/* Instagram */}
            {APP_CONFIG.INSTAGRAM_URL && (
              <a href={APP_CONFIG.INSTAGRAM_URL} target="_blank" rel="noreferrer"
                className="flex items-center gap-3 rounded-xl px-4 py-3 text-left"
                style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)' }}>
                <span className="text-2xl flex-shrink-0">📸</span>
                <div className="min-w-0">
                  <p className="text-sm font-medium text-white">Instagram</p>
                  <p className="text-xs" style={{ color: 'rgba(255,255,255,0.5)' }}>Photos, reels & stories</p>
                </div>
              </a>
            )}
            ...
            {APP_CONFIG.FACEBOOK_URL && (
              <a href={APP_CONFIG.FACEBOOK_URL} target="_blank" rel="noreferrer"
                className="flex items-center gap-3 rounded-xl px-4 py-3 text-left"
                style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)' }}>
                <span className="text-2xl flex-shrink-0">📘</span>
                <div className="min-w-0">
                  <p className="text-sm font-medium text-white">Facebook</p>
                  <p className="text-xs" style={{ color: 'rgba(255,255,255,0.5)' }}>Page updates & community</p>
                </div>
              </a>
            )}
