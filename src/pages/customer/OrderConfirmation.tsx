            ...
            <div className="px-4 py-3">
              ...
              {/* Discount info pills */}
                ...
                <div className="flex-1 bg-white/10 rounded-xl px-3 py-2 text-center">
                  ...
                  <p className="text-white font-bold text-sm">friend gets ₹25 off</p>
                  <p className="text-orange-300 text-xs">+ you earn ₹75</p>
                </div>
                <div className="flex-1 bg-white/10 rounded-xl px-3 py-2 text-center">
                  <p className="text-orange-200 text-xs">Orders ₹500–₹999</p>
                  <p className="text-white font-bold text-sm">friend gets ₹13 off</p>
                  <p className="text-orange-300 text-xs">+ you earn ₹37</p>
                </div>
              </div>
