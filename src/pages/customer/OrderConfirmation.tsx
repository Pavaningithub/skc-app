            ...
            <div className="px-4 py-3">
              ...
              <div className="flex gap-2 mb-3">
                <div className="flex-1 bg-white/10 rounded-xl px-3 py-2 text-center">
                  <p className="text-orange-200 text-xs">Orders ₹500+</p>
                  <p className="text-white font-bold text-sm">5% off</p>
                  <p className="text-orange-300 text-xs">max ₹75</p>
                </div>
                <div className="flex-1 bg-white/10 rounded-xl px-3 py-2 text-center">
                  <p className="text-orange-200 text-xs">Orders below ₹500</p>
                  <p className="text-white font-bold text-sm">2% off</p>
                  <p className="text-orange-300 text-xs">max ₹20</p>
                </div>
              </div>
