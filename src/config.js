...
export const APP_CONFIG = {
    ...
    // ── Contact (from env) ─────────────────────────────────────
    WHATSAPP_NUMBER: import.meta.env.VITE_WHATSAPP_NUMBER, // with country code, no +
    WHATSAPP_DISPLAY: import.meta.env.VITE_WHATSAPP_DISPLAY,
    // ── Payments (from env) ────────────────────────────────────
    UPI_ID: import.meta.env.VITE_UPI_ID,
    UPI_NUMBER: import.meta.env.VITE_UPI_NUMBER,
    UPI_DISPLAY: import.meta.env.VITE_UPI_DISPLAY,
    // ── Admin Security (from env) ────────────────────────────────
    DEFAULT_ADMIN_PIN: import.meta.env.VITE_ADMIN_PIN,
    ...
    WHATSAPP_GROUP_LINK: import.meta.env.VITE_WA_GROUP_LINK,
    WHATSAPP_CHANNEL_LINK: import.meta.env.VITE_WA_CHANNEL_LINK,
    // WhatsApp Community (invite link — set in Vercel env, never in source)
    WHATSAPP_COMMUNITY_URL: import.meta.env.VITE_WA_COMMUNITY_URL || import.meta.env.VITE_WA_GROUP_LINK || '',
    // Internal group for order tracking (admins only)
    ORDER_TRACKING_GROUP_LINK: import.meta.env.VITE_WA_TRACKING_LINK,
